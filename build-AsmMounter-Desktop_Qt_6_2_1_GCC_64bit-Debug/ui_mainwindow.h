...
public:
    ...
    QAction *actionDefine_Config_File;
    QAction *actionDefine_Processor_FIle;
...
"font-size:15px;"));
        ...
        actionDefine_Config_File = new QAction(MainWindow);
        actionDefine_Config_File->setObjectName(QString::fromUtf8("actionDefine_Config_File"));
        actionDefine_Processor_FIle = new QAction(MainWindow);
        actionDefine_Processor_FIle->setObjectName(QString::fromUtf8("actionDefine_Processor_FIle"));
        ...
        TabsTextEditor->addTab(tab, QString());
        ...
        menuOptions->addAction(actionDefine_Config_File);
        menuOptions->addAction(actionDefine_Processor_FIle);

        retranslateUi(MainWindow);

        TabsTextEditor->setCurrentIndex(0);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionDefine_Config_File->setText(QCoreApplication::translate("MainWindow", "Define Config Script", nullptr));
        actionDefine_Processor_FIle->setText(QCoreApplication::translate("MainWindow", "Define Processor Script", nullptr));
        TabsTextEditor->setTabText(TabsTextEditor->indexOf(tab), QCoreApplication::translate("MainWindow", "Page", nullptr));
